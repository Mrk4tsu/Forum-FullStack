...
namespace MrKatsuWebAPI.DataAccess.Migrations
{
    ...
    [Migration("20250428110445_Update_Name_column")]
            ...
            modelBuilder.Entity("MrKatsuWebAPI.DataAccess.Entities.Post", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2025, 4, 28, 11, 4, 44, 727, DateTimeKind.Utc).AddTicks(9356))
                    ...
                    b.Property<DateTime>("UpdatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2025, 4, 28, 11, 4, 44, 728, DateTimeKind.Utc).AddTicks(27))
            ...
            modelBuilder.Entity("MrKatsuWebAPI.DataAccess.Entities.Reply", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2025, 4, 28, 11, 4, 44, 728, DateTimeKind.Utc).AddTicks(7313))
                        .HasColumnName("created_at");
                    ...
                    b.Property<DateTime>("UpdatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2025, 4, 28, 11, 4, 44, 728, DateTimeKind.Utc).AddTicks(8060))
                        .HasColumnName("updated_at");
