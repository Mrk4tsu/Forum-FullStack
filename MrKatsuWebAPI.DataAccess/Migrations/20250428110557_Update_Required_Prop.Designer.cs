...
namespace MrKatsuWebAPI.DataAccess.Migrations
{
    ...
    [Migration("20250428110557_Update_Required_Prop")]
    partial class Update_Required_Prop
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("MrKatsuWebAPI.DataAccess.Entities.Post", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2025, 4, 28, 11, 5, 56, 706, DateTimeKind.Utc).AddTicks(7011))
                    ...
                    b.Property<DateTime>("UpdatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2025, 4, 28, 11, 5, 56, 706, DateTimeKind.Utc).AddTicks(7640))
            ...
            modelBuilder.Entity("MrKatsuWebAPI.DataAccess.Entities.Reply", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2025, 4, 28, 11, 5, 56, 707, DateTimeKind.Utc).AddTicks(4157))
                        .HasColumnName("created_at");
                    ...
                    b.Property<DateTime>("UpdatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2025, 4, 28, 11, 5, 56, 707, DateTimeKind.Utc).AddTicks(4704))
                        .HasColumnName("updated_at");
