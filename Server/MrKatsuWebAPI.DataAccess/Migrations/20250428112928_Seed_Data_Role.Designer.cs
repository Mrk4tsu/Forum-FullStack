...
namespace MrKatsuWebAPI.DataAccess.Migrations
{
    ...
    [Migration("20250428112928_Seed_Data_Role")]
            ...
            modelBuilder.Entity("MrKatsuWebAPI.DataAccess.Entities.Post", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2025, 4, 28, 11, 29, 27, 842, DateTimeKind.Utc).AddTicks(7285))
                    ...
                    b.Property<DateTime>("UpdatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2025, 4, 28, 11, 29, 27, 842, DateTimeKind.Utc).AddTicks(7869))
            ...
            modelBuilder.Entity("MrKatsuWebAPI.DataAccess.Entities.Reply", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2025, 4, 28, 11, 29, 27, 843, DateTimeKind.Utc).AddTicks(4095))
                        .HasColumnName("created_at");
                    ...
                    b.Property<DateTime>("UpdatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2025, 4, 28, 11, 29, 27, 843, DateTimeKind.Utc).AddTicks(4729))
                        .HasColumnName("updated_at");
